 ...
 * Form: LinkedIn Demo
 * Version: 1
 * Table: form_data.linkedin_demo_v1
 * Generated: 2026-07-30 10:19:11
 *
...
$form = [
    'form_id' => 37,
    'form_name' => 'LinkedIn Demo',
    'form_description' => 'Demo',
    'form_version' => 1,
    'table_name' => 'form_data.linkedin_demo_v1',
    'fields' => [
        [
            'field_label' => 'Demo Field',
        ...
        [
            'field_label' => 'Demo_field 2',
            'field_name' => 'demo_field_2',
            'field_type' => 'datetime',
            'data_type' => 'TIMESTAMP',
            'is_required' => false,
        ],
        [
            'field_label' => 'Demo Three 3',
            'field_name' => 'demo_three_3',
            'field_type' => 'text',
            'data_type' => 'VARCHAR',
            'is_required' => false,
        ],
    ...
    if ($action === 'draft') {
        try {
            ...
            auditLog('form_draft_save', 'form_submissions', $draftId,
                "Draft saved for \"LinkedIn Demo\" / patient " . $patientNumber);
        ...
        if (empty($errors)) {
            try {
                ...
                auditLog('form_submit', 'form_submissions', $submissionId,
                    "Submitted \"LinkedIn Demo\" for patient " . $patientNumber);
...
<div class="form-page">
    ...
    <div class="form-meta-header">
        ...
        <div class="form-meta-details">
            <span><span class="patient-chip-label">Form ID</span> <strong>#37</strong></span>
            <span><span class="patient-chip-label">Fields</span> <strong>3</strong></span>
...
<div class="form-group">
    <label for="demo_field">Demo Field <span class="required">*</span></label>
    <input type="text" id="demo_field" name="demo_field" class="form-control" value="<?= escape($prefill('demo_field')) ?>" required>
</div>
<div class="form-group">
    <label for="demo_field_2">Demo_field 2</label>
    <input type="datetime-local" id="demo_field_2" name="demo_field_2" class="form-control" value="<?= escape($prefill('demo_field_2')) ?>">
</div>
<div class="form-group">
    <label for="demo_three_3">Demo Three 3</label>
    <input type="text" id="demo_three_3" name="demo_three_3" class="form-control" value="<?= escape($prefill('demo_three_3')) ?>">
</div>
